...
class PrestigeSystem {
     ...
     * Formula: floor(sqrt(lifetimeEarnings / 1,000,000)) - currentNip
     */
    calculateClaimableNip() {
        ...
        const claimable = totalPotentialNip - this.state.prestigeCurrency;
     ...
     */
    getNextNipCost() {
        const currentTotal = this.state.prestigeCurrency + this.calculateClaimableNip();
